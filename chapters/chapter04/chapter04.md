...
## 5. 금액으로 보면 — 진입·퇴출은 얼마나 되나

개수로는 진입·퇴출이 각각 300종 남짓이었다. 그렇다면 그 품목들이 **금액으로는 무역의 얼마**를 차지할까? 거의 없다.

- 진입 품목의 2025년 수출액은 **24억 달러 — 전체(7,088억)의 0.33%**.
- 퇴출 품목의 2007년 수출액은 **6억 달러 — 전체(3,709억)의 0.16%**.

20년간 품목이 300종씩 들고 났지만, 그 교체가 차지하는 금액은 1%에도 한참 못 미친다. **개수로는 눈에 띄는 변화가 금액으로는 사실상 무시할 수준**이다 — 챕터 1의 봉인 2가 말한 "개수와 거래액은 다른 지표"가 여기서 그대로 드러난다.

### 금액 기준 상위 진입 품목 (2025)

| HS6 | 품목명 | 2025 수출(억달러) |
|-----|------|------:|
| 930110 | 자주식 무기(자주포 등) | 7.4 |
| 890610 | 군함 | 4.9 |
| 930120 | 로켓·유탄·어뢰 발사장치 | 4.3 |
| 240411 | 가열·전자담배류(연소 없이 흡입) | 2.6 |
| 283691 | 탄산리튬(배터리 소재) | 1.2 |
| 291733 | 오르토프탈산디노닐 | 0.4 |
| 284180 | 텅스텐산염 | 0.3 |
| 282570 | 산화몰리브덴 | 0.3 |

진입 상위는 **방산(자주포·군함·발사장치), 가열담배, 배터리 소재(탄산리튬)** 등 최근 부상한 산업의 흔적이다. 다만 모두 연 수억 달러의 소액이다.

### 금액 기준 상위 퇴출 품목 (2007)

| HS6 | 품목명(2026 기준명) | 2007 수출(억달러) |
|-----|------|------:|
| 854011 | 컬러 브라운관(CRT) 텔레비전 수상관 | 4.6 |
| 860390 | 자주식 철도 객차 | 0.5 |
| (그 외) | 대부분 연 0.1억 달러 미만 | ~0 |

가장 크게 사라진 품목은 **컬러 브라운관(CRT) TV 수상관**(HS 854011)이다 — LCD·OLED에 밀려 도태된 기술의 흔적이다. 그 밖의 퇴출 품목은 대부분 연 0.1억 달러 미만이다. (2007년에만 있던 코드라 폐지코드가 섞여 품목명이 불완전한 경우가 있다 — 챕터 1의 "정직한 NULL" 참조.)

핵심 수출품(반도체·자동차·석유제품 등)은 20년 내내 "지속" 쪽에 있다. **진입·퇴출은 개수로도 주변부이고, 금액으로는 더더욱 주변부**에서 일어난다. (이 글은 어떤 품목이 들고 났는지의 *사실*만 기록하며, 그 배경은 다루지 않는다.)
