...
구간과 개정의 대응:
  별표 판본 사이에 개정이 둘 이상 낀 구간이 있다. 정직하게 적어 둔다.
    2007→2008 = 2008년 개정
    2008→2009 = 2009년 개정
    2009→2011 = 2011년 개정. 받아 둔 별표의 고시일이 2011-05-20이지만 그 개정으로
                생긴 29개 중 27개가 이미 1~3월에 거래돼 시행은 1월 1일로 본다.
                2010년 판본은 2009년과 코드가 완전히 같아 2010년에는 개정이 없었다.
                거래 자료에서 2010년 1월에 처음 나타나는 코드 15개는 전부 2009년
                표에 이미 있던 것이다.
...
담지 못한 것:
  2026년 개정. 별표는 2011년 것이 가장 이르고, 신구대조표는 재정경제부가
...
SPANS = [
    ("2008", 200801, 2007, 2008),
    ("2009", 200901, 2008, 2009),
    ("2011", 201101, 2009, 2011),
...
EFFECTIVE = {"2008": 200801, "2009": 200901, "2011": 201101, "2012": 201201,
             "2014": 201401, "2017": 201701, "2019": 201910, "2021": 202101,
             "2022": 202201, "2025": 202501}
...
def load_byeolpyo(con) -> dict[int, pd.DataFrame]:
    out = {}
    for y in (2007, 2008, 2009, 2011, 2013, 2015, 2017, 2021):
        df = con.execute(
