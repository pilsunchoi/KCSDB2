...
- 참조·연결 (dim_country, dim_hs10, dim_hs6_concordance, dim_hs10_concordance, dim_hs10_to_2022)
- 내부 무결성 검증
...
8. hs10 → dim_hs10_to_2022 커버리지 (시기별 past_version 조인, 거래액 기준)
9. dim_hs10_* 가중치 합 = 1 (출발 코드별), 전 기간 재집계 총액 = 원자료 총액
